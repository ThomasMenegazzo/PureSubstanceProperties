...
void CSubstancia::Display()
{
	if (pressao.valor!=0){
		std::cout<<"***************************************";
		std::cout<<std::endl<<"Pressao: "<<pressao.valor<<" Bar";
		if(pressao.t!=0.0){
	...
	if (entalpia.valor!=0){
		std::cout<<"***************************************";
		std::cout<<std::endl<<"Entalpia: "<<entalpia.valor<<" kJ/kg";
		if(entalpia.t!=0.0){
	...
	if (entropia.valor!=0){
		std::cout<<"***************************************";
		std::cout<<std::endl<<"Entropia: "<<entropia.valor<<" kJ/(kg.K)";
		if(entropia.t!=0.0){
	...
	if (energiaInterna.valor!=0){
		std::cout<<"***************************************";
		std::cout<<std::endl<<"Energia Interna: "<<energiaInterna.valor<<" kJ/kg";
	...
	if (capCalorificaIsobarica.valor!=0){
		std::cout<<"***************************************";
		std::cout<<std::endl<<"Capacidade Calorifica Isobarica: "<<capCalorificaIsobarica.valor<<" kJ/(kg.K)";
	...
	if (capCalorificaIsovolumetrica.valor!=0){
		std::cout<<"***************************************";
		std::cout<<std::endl<<"Capacidade Calorifica Isovolumetrica: "<<capCalorificaIsovolumetrica.valor<<" kJ/(kg.K)";
	...
	if (velocidadeSom.valor!=0){
		std::cout<<"***************************************";
		std::cout<<std::endl<<"Velocidade do Som: "<<velocidadeSom.valor<<" m/s";
