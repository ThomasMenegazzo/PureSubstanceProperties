#include "CSimuladorPropriedades.hpp"
#include <iostream>
#include <cmath>
...
{
	std::cout<<std::endl<<"Calculando propriedades para "<<substancia.nome<<" a T="<<substancia.temperatura<<" Kelvin e D="<<substancia.densidade<<" kg/m3:"<<std::endl;
	substancia.Display();	
}
